<x-app-layout>
    ...
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <p class="text-gray-500">Kelola data surat keluar dan dokumen digital inspektorat.</p>
        ...
        <!-- Search Only -->
        <form action="{{ route('surat-keluar.index') }}" method="GET" class="relative flex-1">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-gray-600">
                    ...
                    <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <span
                                            class="w-6 h-6 rounded bg-green-100 flex items-center justify-center text-xs font-bold text-green-600">
                                            {{ substr($surat->tujuan, 0, 1) }}
                                        </span>
                                        <span class="font-medium text-gray-900">{{ $surat->tujuan }}</span>
                                    </div>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-gray-400">Belum ada data surat keluar.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
