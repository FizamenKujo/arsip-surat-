            ...
            <form action="{{ route('petugas.store') }}" method="POST"
                ...
                <div>
                    ...
                    <input type="text" name="nip"
                        class="w-full border-gray-200 rounded-lg bg-gray-50 text-sm focus:border-blue-500 focus:ring-blue-500"
                        placeholder="Contoh: 19850101..." required>
                </div>
                <div>
                ...
                <div class="md:col-span-4 flex justify-end">
                    <button type="submit"
                        class="px-6 py-2.5 bg-blue-600 text-white font-medium text-sm rounded-lg hover:bg-blue-700 transition">Simpan
                        Data</button>
                </div>
            </form>
        </div>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('petugas.edit', $p->id) }}"
                                        class="text-gray-400 hover:text-blue-600 mr-2"><svg class="w-5 h-5" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z">
                                            </path>
                                        </svg></a>
                                    <button class="text-gray-400 hover:text-red-600"><svg class="w-5 h-5" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
